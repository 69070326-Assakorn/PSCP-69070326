...
```text
สร้างตัวแปรรับค่าขนาดและช่องจากนั้นคำนวนหาว่าช่องสุดท้ายอยู่แถวไหนแล้วเอาเลขแถวไปหาแถบต่อ
```
...
```text
Step 1:สร้างตัวแปรรับค่าขนาดและช่อง
Step 2:หาว่าช่องNอยู่แถวที่เท่าไหร่
Step 3:เอาแถวนั้นไปหาเลขแถบแล้วแสดงผล
```
...
```text
เหมือนกับที่คิดไว้ และคำนวนช่องแถวถูก
```
...
```text
ทดลองว่าถ้าเลขหลัก100จะยังถูกจุดไหม
```
...
```text
ทดลองถ้าอยู่ใกล้ๆ ค่าน้อยๆ จะคำนวนถูกไหม
```
