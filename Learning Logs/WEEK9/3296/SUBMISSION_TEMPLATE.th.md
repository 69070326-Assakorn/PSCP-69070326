...
```text
สร้างตัวแปรรับค่าสีRGBสีที่1และ2 จากนั้นนำเลขทั้งสองมารวมกันแล้วหาค่าเฉลี่ยแล้วแสดงผลสีใหม่
```
...
```text
Step 1:รับสีRGB 2สี
Step 2:นำสีมารวมกันแล้วหาร2เพื่อหาค่าเฉลี่ยและเอาเฉพาะจำนวนเต็ม
Step 3:นำเลขที่ได้มาแสดงผล
```
...
```text
เหมือนกับที่คิดไว้ และมาเป็นจำนวนเต็ม
```
...
```text
ทดสอบว่าถ้าหารไม่ลง จะปัดเศษไหม
```
