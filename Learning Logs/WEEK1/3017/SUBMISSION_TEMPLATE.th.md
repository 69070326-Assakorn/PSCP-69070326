...
```
สร้างตัวแปรรับinputค่าราคาทั้งหมด และคำนวณค่าบริการและvat จากนั้นprintราคาสุดท้ายที่รวมค่าบริการและvatออกมาโดยที่ค่าบริการขั้นต่ำคือ50และแพงสุดคือ1000โดยprintออกมาเป็นทศนิยม2ตำแหน่ง
---
...
```text
Step 1:สร้างตัวแปรรับจำนวนราคาทั้งหมด
Step 2:คำนวณค่าบริการ10%และตั้งให้ขั้นต่ำคือ50และมากสุดคือ1000 และจากนั้นเอาราคาทั้งหมดก่อนหน้านี้ไปรวมกับค่าบริการแล้วคำนวณหาค่าvat7%
Step 3:printราคาทั้งหมดที่รวมมาจาก ราคาทั้งหมดเดิมรวมกับค่าบริการและรวมvatโดยให้มีทศนิยม2ตำแหน่ง
```
...
```text
เหมือนกับที่คิดไว้ เพราะคำนวณถูกต้องและprintมาเป็นทศนิยม2ตำแหน่ง
```
...
```text
อยากรู้ว่าถ้าคำนวนออกมาจะprintมีทศนิยม2ตัวออกมาหรือไม่
```
...
```text
อยากรู้ว่าถ้าให้ทศนิยมมา2ตำแหน่งมันจะเกิน2ตำแหน่งไหม
```
...
```text
อยากลองว่าถ้าเลขเยอะๆจะคำนวณพลาดไหม
```
