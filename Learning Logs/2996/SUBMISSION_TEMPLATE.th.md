...
```text
ให้รับค่าinputเป็นข้อความที่ความยาว5ตัวและoutputเป็นข้อความที่รับมาแต่แสดงผลจากตัวหลังสุดไปตัวหน้าสุดโดยที่ต้องเป็นตัวพิมพ์เล็กทั้งหมด
```
...
```text
Step 1:กำหนดตัวแปรเพื่อใช้เก็บข้อความมา
Step 2:สลับตัวอักษรจากหน้าไปหลังเปลี่ยนเป็นหลังไปหน้าด้วยwordพร้อมทั้งเปลี่ยนให้เป็นตัวพิมพ์เล็กทั้งหมดด้วย
Step 3:printข้อความที่กลับเสร็จแล้วและเป็นตัวเล็กมา
```
...
```text
เหมือนกับที่คิดไว้ เพราะข้อความที่รับมา5ตัวกลับจากหน้าไปหลังเป็นหลังไปหน้าได้ถูกต้องและทุกตัวเป็นตัวพิมพ์เล็ก
```
...
```text
เช็คว่าแปลงเป็นตัวพิมพ์เล็กทุกตัวไหม
```
...
```text
อยากรู้ว่าถ้าลองใส่มากกว่า5ตัวจะกลับได้ทุกตัวไหม
```
...
```text
ข้อนี้ทำร่วมกับคู่pair
```

เขาช่วยอะไร

```text
บอกว่าตอนค่ายpre-programming69 สอนอะไรบ้างและแต่ละตัวทำอะไรได้บ้างเช่นกับข้อนี้เพื่อนบอก.lower()ทำให้ตัวเล็กทุกตัว และสลับตัวอักษรจากหน้าไปหลังเป็นหลังไปหน้าคือ[::-1]
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดด้วยตัวเองจากที่เพื่อนอธิบายให้ฟังมา
```
